...
*/
//debug
uint8_t debugGscart1 = 0; // line ~882
uint8_t debugGscart2 = 0; // line ~1019
uint8_t debugE1CAP = 0; // line ~301
uint8_t debugE2CAP = 0; // line ~634
...
void readExtron1(){
    ...
    else if(ecap.substring(0,3) == "Rpr"){
...
void readExtron2(){
    ...
    else if(ecap2.substring(0,3) == "Rpr"){
