...
uint8_t const MTVIKIir = 1;   // Must have IR "Receiver" connected to the Donut Dongle for option 1 & 2.
...
void readExtron1(){
    ...
    if((einput.substring(0,2) == "In") || (einput.substring(0,3) == "Rpr")){
